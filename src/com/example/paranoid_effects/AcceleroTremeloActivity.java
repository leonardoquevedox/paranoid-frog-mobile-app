...
public class AcceleroTremeloActivity extends Activity implements
		SensorEventListener {
	...
	AcceleroTremelo accelero = new AcceleroTremelo();

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_accelero_tremelo);
