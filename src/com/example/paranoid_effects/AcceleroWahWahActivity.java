...
public class AcceleroWahWahActivity extends Activity implements SensorEventListener {
	...
	Thread loopThread = new Thread(new Runnable(){
		@Override
		public void run() {
						accelero.AcceleroWahWahLoop();
					}
		}
	);
	
	
	AcceleroWahWah accelero = new AcceleroWahWah();
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_accelerowahwah);
